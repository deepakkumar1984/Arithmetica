...
namespace Arithmetica.LinearAlgebra
{
    public partial class Vector<T>
    {
        ...
        /// <returns></returns>
        public static SuperArray Floor(Vector<T> src) => Global.OP.Floor(src.variable);
        ...
        /// <param name="src">The source Vector<T>.</param>
        /// <returns></returns>
        public static SuperArray Round(Vector<T> src) => Global.OP.Round(src.variable);
        ...
        /// <param name="src">The source Vector<T>.</param>
        /// <returns></returns>
        public static SuperArray Trunc(Vector<T> src) => Global.OP.Trunc(src.variable);
        ...
        /// <param name="src">The source Vector<T>.</param>
        /// <returns></returns>
        public static SuperArray Ceil(Vector<T> src) => Global.OP.Ceil(src.variable);
        ...
        /// <returns></returns>
        public static SuperArray Clip(Vector<T> src, float min, float max) => Global.OP.Clip(src.variable, min, max);
        ...
        /// <param name="src">The source Vector<T>.</param>
        /// <returns></returns>
        public static SuperArray Frac(Vector<T> src) => Global.OP.Frac(src.variable);
        ...
        ///// <param name="src">The source Vector<T>.</param>
        ///// <returns></returns>
        //public static SuperArray Std(Vector<T> src) => Global.OP.Std(src.variable);
        ...
        ///// <param name="src">The source Vector<T>.</param>
        ///// <returns></returns>
        //public static SuperArray Std(Vector<T> src, bool normbyN, int dimension) => Global.OP.Std(src.variable, dimension, normbyN);
