...
namespace Arithmetica.LinearAlgebra.Double
{
	...
	public class Vector2 : ICloneable
	{
		...
		/// </summary>
		/// <param name="coordinates">An array containing the coordinate parameters.</param>
		public Vector2(List<double> coordinates)
		{
			Debug.Assert(coordinates != null);
		...
		/// <returns>A new <see cref="Vector2"/> instance containing the sum.</returns>
		public static Vector2 Add(Vector2 vector, double scalar)
		{
		...
		/// <param name="scalar">A double-precision floating-point number.</param>
		/// <param name="result">A <see cref="Vector2"/> instance to hold the result.</param>
		public static void Add(Vector2 vector, double scalar, ref Vector2 result)
		{
		...
		/// </remarks>
		public static Vector2 Subtract(Vector2 vector, double scalar)
		{
			return new Vector2(vector.X - scalar, vector.Y - scalar);
		}
		/// <summary>
		...
		/// </remarks>
		public static Vector2 Subtract(double scalar, Vector2 vector)
		{
		...
		/// result[i] = vector[i] - scalar
		/// </remarks>
		public static void Subtract(Vector2 vector, double scalar, ref Vector2 result)
		{
			result.X = vector.X - scalar;
			result.Y = vector.Y - scalar;
		}
		...
		/// result[i] = scalar - vector[i]
		/// </remarks>
		public static void Subtract(double scalar, Vector2 vector, ref Vector2 result)
		{
		...
		/// result[i] = vector[i] / scalar
		/// </remarks>
		public static void Divide(Vector2 vector, double scalar, ref Vector2 result)
		{
			result.X = vector.X / scalar;
			result.Y = vector.Y / scalar;
		}
		...
		/// result[i] = scalar / vector[i]
		/// </remarks>
		public static void Divide(double scalar, Vector2 vector, ref Vector2 result)
		{
			result.X = scalar / vector.X;
			result.Y = scalar / vector.Y;
		}
		...
		/// <param name="scalar">A double-precision floating-point number.</param>
		/// <param name="result">A <see cref="Vector2"/> instance to hold the result.</param>
		public static void Multiply(Vector2 vector, double scalar, ref Vector2 result)
		{
			result.X = vector.X * scalar;
			result.Y = vector.Y * scalar;
		}
		...
		/// </p>
		/// </remarks>
		public static double KrossProduct(Vector2 left, Vector2 right)
		{
		...
		/// <returns><see langword="true"/> if the two vectors are approximately equal; otherwise, <see langword="false"/>.</returns>
		public static bool ApproxEqual(Vector2 left, Vector2 right, double tolerance)
		{
			return
				(
		...
		public static explicit operator double[](Vector2 vector)
		{
		...
		public static explicit operator List<double>(Vector2 vector)
		{
		...
		public static explicit operator LinkedList<double>(Vector2 vector)
		{
