...
namespace Arithmetica.LinearAlgebra.Double
{
	...
	public struct Matrix2 : ICloneable
	{
		...
		/// </summary>
		/// <param name="elements">An array containing the matrix values in row-major order.</param>
		public Matrix2(List<double> elements)
		{
			Debug.Assert(elements != null);
		...
		/// <returns>A new <see cref="Matrix2"/> instance containing the sum.</returns>
		public static Matrix2 Add(Matrix2 matrix, double scalar)
		{
			return new Matrix2(
		...
		/// <param name="scalar">A double-precision floating-point number.</param>
		/// <param name="result">A <see cref="Matrix2"/> instance to hold the result.</param>
		public static void Add(Matrix2 matrix, double scalar, ref Matrix2 result)
		{
		...
		/// <param name="scalar">A double-precision floating-point number.</param>
		/// <returns>A new <see cref="Matrix2"/> instance containing the difference.</returns>
		public static Matrix2 Subtract(Matrix2 matrix, double scalar)
		{
			return new Matrix2(
				matrix.M11 - scalar, matrix.M12 - scalar,
				matrix.M21 - scalar, matrix.M22 - scalar
		...
		/// <param name="scalar">A double-precision floating-point number.</param>
		/// <param name="result">A <see cref="Matrix2"/> instance to hold the result.</param>
		public static void Subtract(Matrix2 matrix, double scalar, ref Matrix2 result)
		{
			result.M11 = matrix.M11 - scalar;
			result.M12 = matrix.M12 - scalar;
