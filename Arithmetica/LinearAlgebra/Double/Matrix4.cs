...
namespace Arithmetica.LinearAlgebra.Double
{
	...
	public struct Matrix4 : ICloneable
	{
		...
		/// </summary>
		/// <param name="elements">An array containing the matrix values in row-major order.</param>
		public Matrix4(List<double> elements)
		{
			Debug.Assert(elements != null);
		...
		/// <returns>A new <see cref="Matrix4"/> instance containing the sum.</returns>
		public static Matrix4 Add(Matrix4 matrix, double scalar)
		{
			return new Matrix4(
		...
		/// <param name="scalar">A double-precision floating-point number.</param>
		/// <param name="result">A <see cref="Matrix4"/> instance to hold the result.</param>
		public static void Add(Matrix4 matrix, double scalar, ref Matrix4 result)
		{
		...
		/// <param name="scalar">A double-precision floating-point number.</param>
		/// <returns>A new <see cref="Matrix4"/> instance containing the difference.</returns>
		public static Matrix4 Subtract(Matrix4 matrix, double scalar)
		{
			return new Matrix4(
				matrix.M11 - scalar, matrix.M12 - scalar, matrix.M13 - scalar, matrix.M14 - scalar,
				matrix.M21 - scalar, matrix.M22 - scalar, matrix.M23 - scalar, matrix.M24 - scalar,
		...
		/// <param name="scalar">A double-precision floating-point number.</param>
		/// <param name="result">A <see cref="Matrix4"/> instance to hold the result.</param>
		public static void Subtract(Matrix4 matrix, double scalar, ref Matrix4 result)
		{
			result.M11 = matrix.M11 - scalar;
			result.M12 = matrix.M12 - scalar;
			result.M13 = matrix.M13 - scalar;
...
//			return det;
		...
		{
			ArithMath.Swap<double>(ref _m12, ref _m21);
			ArithMath.Swap<double>(ref _m13, ref _m31);
			ArithMath.Swap<double>(ref _m14, ref _m41);
			ArithMath.Swap<double>(ref _m23, ref _m32);
			ArithMath.Swap<double>(ref _m24, ref _m42);
			ArithMath.Swap<double>(ref _m34, ref _m43);
		}
		#endregion
