...
namespace Arithmetica.LinearAlgebra.Double
{
	...
	public struct Vector4 : ICloneable
	{
		...
		/// </summary>
		/// <param name="coordinates">An array containing the coordinate parameters.</param>
		public Vector4(List<double> coordinates)
		{
			Debug.Assert(coordinates != null);
		...
		/// <returns>A new <see cref="Vector4"/> instance containing the sum.</returns>
		public static Vector4 Add(Vector4 vector, double scalar)
		{
		...
		/// <param name="scalar">A double-precision floating-point number.</param>
		/// <param name="result">A <see cref="Vector4"/> instance to hold the result.</param>
		public static void Add(Vector4 vector, double scalar, ref Vector4 result)
		{
		...
		/// </remarks>
		public static Vector4 Subtract(Vector4 vector, double scalar)
		{
			return new Vector4(vector.X - scalar, vector.Y - scalar, vector.Z - scalar, vector.W - scalar);
		}
		/// <summary>
		...
		/// </remarks>
		public static Vector4 Subtract(double scalar, Vector4 vector)
		{
		...
		/// result[i] = vector[i] - scalar
		/// </remarks>
		public static void Subtract(Vector4 vector, double scalar, ref Vector4 result)
		{
			result.X = vector.X - scalar;
			result.Y = vector.Y - scalar;
			result.Z = vector.Z - scalar;
		...
		/// result[i] = scalar - vector[i]
		/// </remarks>
		public static void Subtract(double scalar, Vector4 vector, ref Vector4 result)
		{
		...
		/// result[i] = vector[i] / scalar;
		/// </remarks>
		public static Vector4 Divide(Vector4 vector, double scalar)
		{
			return new Vector4(vector.X / scalar, vector.Y / scalar, vector.Z / scalar, vector.W / scalar);
		}
		/// <summary>
		...
		/// result[i] = scalar / vector[i]
		/// </remarks>
		public static Vector4 Divide(double scalar, Vector4 vector)
		{
			return new Vector4(scalar / vector.X, scalar / vector.Y, scalar / vector.Z, scalar / vector.W);
		}
		/// <summary>
		...
		/// result[i] = vector[i] / scalar
		/// </remarks>
		public static void Divide(Vector4 vector, double scalar, ref Vector4 result)
		{
			result.X = vector.X / scalar;
			result.Y = vector.Y / scalar;
			result.Z = vector.Z / scalar;
		...
		/// result[i] = scalar / vector[i]
		/// </remarks>
		public static void Divide(double scalar, Vector4 vector, ref Vector4 result)
		{
			result.X = scalar / vector.X;
			result.Y = scalar / vector.Y;
			result.Z = scalar / vector.Z;
		...
		/// <param name="scalar">A double-precision floating-point number.</param>
		/// <param name="result">A <see cref="Vector4"/> instance to hold the result.</param>
		public static void Multiply(Vector4 vector, double scalar, ref Vector4 result)
		{
			result.X = vector.X * scalar;
			result.Y = vector.Y * scalar;
			result.Z = vector.Z * scalar;
		...
		public static double DotProduct(Vector4 left, Vector4 right)
		{
		...
		/// <returns><see langword="true"/> if the two vectors are approximately equal; otherwise, <see langword="false"/>.</returns>
		public static bool ApproxEqual(Vector4 left, Vector4 right, double tolerance)
		{
			return
				(
		...
		public static explicit operator double[](Vector4 vector)
		{
		...
		public static explicit operator List<double>(Vector4 vector)
		{
		...
		public static explicit operator LinkedList<double>(Vector4 vector)
		{
