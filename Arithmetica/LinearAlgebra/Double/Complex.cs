...
namespace Arithmetica.LinearAlgebra.Double
{
	...
	public class Complex : ICloneable
	{
		...
		/// </summary>
		/// <value>A double-precision doubleing-point number.</value>
		...
		/// <param name="scalar">A double-precision doubleing-point value.</param>
		/// <returns>A new <see cref="Complex"/> instance containing the sum.</returns>
		...
		/// <param name="right">A <see cref="Complex"/> instance.</param>
		/// <returns>A new <see cref="Complex"/> instance containing the result.</returns>
		/// <remarks>See http://mathworld.wolfram.com/Complexivision.html for further details.</remarks>
        ...
        public static double Abs(Complex complex)
        {
            ...
            {
                double r = d / c;
                result = c * (double)Math.Sqrt(1.0 + r * r);
            }
            else if (d == 0.0)
            {
            ...
            {
                double r = c / d;
                result = d * (double)Math.Sqrt(1.0 + r * r);
            }
		...
		public static Complex Log(Complex complex)
		{
			...
			else if (complex.Real == 0.0)
			{
				if (complex.Imaginary > 0.0)
				{
					...
					result.Imaginary = ArithMath.HalfPI;
				}
				else
				{
					result.Real = System.Math.Log(-(complex.Imaginary));
		...
		public static Complex Cot(Complex complex)
		{
			...
			if (complex.IsReal)
			{
				result.Real = ArithMath.Cot(complex.Real);
			}
			else
			{
		...
		public static Complex Sec(Complex complex)
		{
			...
			{
				double cosr = ArithMath.Cos(complex.Real);
				double sinhi = ArithMath.Sinh(complex.Imaginary);
				double denom = cosr * cosr + sinhi * sinhi;
				result.Real = (cosr * ArithMath.Cosh(complex.Imaginary)) / denom;
				result.Imaginary = (ArithMath.Sin(complex.Real) * sinhi) / denom;
			}
		...
		public static Complex Csc(Complex complex)
		{
			...
			if (complex.IsReal)
			{
				result.Real = ArithMath.Csc(complex.Real);
			}
			else
			{
				double sinr = ArithMath.Sin(complex.Real);
				double sinhi = ArithMath.Sinh(complex.Imaginary);
				double denom = sinr * sinr + sinhi * sinhi;
				result.Real = (sinr * ArithMath.Cosh(complex.Imaginary)) / denom;
				result.Imaginary = (-ArithMath.Cos(complex.Real) * sinhi) / denom;
			}
		...
		public static Complex Atan(Complex complex)
		{
			...
			return (new Complex(0, 0.5)) * (Complex.Log(1 - tmp) - Complex.Log(1 + tmp));
		}
		public static Complex Acot(Complex complex)
		{
			Complex tmp = new Complex(-complex.Imaginary, complex.Real);
			return (new Complex(0, 0.5)) * (Complex.Log(1 + tmp) - Complex.Log(1 - tmp)) + ArithMath.HalfPI;
		}
		...
		public static Complex Sinh(Complex complex)
		{
			if (complex.IsReal)
			{
				return new Complex(System.Math.Sinh(complex.Real), 0.0);
			}
		...
		public static Complex Cosh(Complex complex)
		{
			if (complex.IsReal)
			{
				return new Complex(System.Math.Cosh(complex.Real), 0.0);
			}
		...
		public static Complex Tanh(Complex complex)
		{
			if (complex.IsReal)
			{
				return new Complex(System.Math.Tanh(complex.Real), 0.0);
			}
		...
		public static Complex Coth(Complex complex)
		{
			if (complex.IsReal)
			{
				return new Complex(ArithMath.Coth(complex.Real), 0.0);
			}

			//return Complex.Divide(Cosh(complex), Sinh(complex));
		...
		public static Complex Sech(Complex complex)
		{
			if (complex.IsReal)
			{
				return new Complex(ArithMath.Sech(complex.Real), 0.0);
			}
		...
		public static Complex Csch(Complex complex)
		{
			if (complex.IsReal)
			{
				return new Complex(ArithMath.Csch(complex.Real), 0.0);
			}
		...
		{
			return 0.5 * (Complex.Log(1 + complex) - Complex.Log(1 - complex));
		}
		public static Complex Acoth(Complex complex)
		{
			return 0.5 * (Complex.Log(complex + 1) - Complex.Log(complex - 1));
		}
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.Int32"/> to <see cref="Complex"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.Single"/> to <see cref="Complex"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.Double"/> to <see cref="Complex"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
