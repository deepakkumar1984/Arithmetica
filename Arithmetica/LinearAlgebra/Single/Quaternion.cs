...
{
	/// <summary>
	/// Represents a float-precision floating-point quaternion.
	/// </summary>
	/// <remarks>
	/// <para>
	...
	public struct Quaternion : ICloneable
	{
		...
		/// </summary>
		/// <value>A float-precision floating-point number.</value>
		...
		/// <summary>
		/// Converts the quaternion to an array of float-precision floating point numbers.
		/// </summary>
		/// <param name="quaternion">A <see cref="Quaternion"/> instance.</param>
		/// <returns>An array of float-precision floating point numbers.</returns>
		/// <remarks>The array is [w, x, y, z].</remarks>
		public static explicit operator float[](Quaternion quaternion)
		{
			float[] floats = new float[4];
			floats[0] = quaternion.W;
			floats[1] = quaternion.X;
			floats[2] = quaternion.Y;
			floats[3] = quaternion.Z;
			return floats;
		}
		#endregion
	}
