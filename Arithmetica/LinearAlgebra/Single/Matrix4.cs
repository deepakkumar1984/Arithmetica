...
//			return det;
		...
		{
			ArithMath.Swap<float>(ref _m12, ref _m21);
			ArithMath.Swap<float>(ref _m13, ref _m31);
			ArithMath.Swap<float>(ref _m14, ref _m41);
			ArithMath.Swap<float>(ref _m23, ref _m32);
			ArithMath.Swap<float>(ref _m24, ref _m42);
			ArithMath.Swap<float>(ref _m34, ref _m43);
		}
		#endregion
