...
// ***********************************************************************
// <copyright file="CpuRandom.cs" company="Arithmetica">
...
namespace Arithmetica.Cpu
{
    ...
    public class CpuRandom
    {
        ...
        public void Uniform(ArithArray result, int? seed, float min, float max) { InvokeWithRng(seed, uniform_func, null, result, min, max); }
        ...
        public void Normal(ArithArray result, int? seed, float mean, float stdv) { InvokeWithRng(seed, normal_func, null, result, mean, stdv); }
        ...
        public void Exponential(ArithArray result, int? seed, float lambda) { InvokeWithRng(seed, exponential_func, null, result, lambda); }
        ...
        public void Cauchy(ArithArray result, int? seed, float median, float sigma) { InvokeWithRng(seed, cauchy_func, null, result, median, sigma); }
        ...
        public void LogNormal(ArithArray result, int? seed, float mean, float stdv) { InvokeWithRng(seed, log_normal_func, null, result, mean, stdv); }
        ...
        public void Geometric(ArithArray result, int? seed, float p) { InvokeWithRng(seed, geometric_func, null, result, p); }
        ...
        public void Bernoulli(ArithArray result, int? seed, float p) { InvokeWithRng(seed, bernoulli_func, null, result, p); }
    }
}
