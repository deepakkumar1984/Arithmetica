...
namespace Arithmetica.Analysis
{
	...
	public class TrapezoidIntegral : ICloneable, IDoubleIntegrator
	{
		...
		private double defaultIteration(ArithMath.UnaryFunction<double> f, double a, double b, double estimate, int n)
		{
			double sum = 0;
		...
		private double midPointIteration(ArithMath.UnaryFunction<double> f, double a, double b, double estimate, int n)
		{
			double sum = 0;
			double stepSize = (b - a) / n;
