...
// ***********************************************************************
// <copyright file="TensorSerialization.cs" company="Arithmetica">
...
namespace Arithmetica
{
    ...
    internal static class ArraySerialization
    {
        ...
        public static void Serialize(ArithArray array, Stream stream)
        {
            using (var src = ArrayOps.AsContiguous(array))
            {
        ...
        public static ArithArray Deserialize(Stream stream)
        {
            ...
            var result = new ArithArray(sizes, elementType);
