...
// ***********************************************************************
// <copyright file="ArrayFormatting.cs" company="Arithmetica">
...
namespace Arithmetica
{
    ...
    /// </summary>
    internal static class ArrayFormatting
    {
        /// <summary>
        ...
        private static bool IsIntOnly(Storage storage, ArithArray array)
        {
            ...
            var maxOffset = minOffset + ArrayDimensionHelpers.GetStorageSize(array.Shape, array.Strides) - 1;
        ...
        /// <param name="array">The array.</param>
        /// <returns>System.String.</returns>
        public static string FormatTensorTypeAndSize(ArithArray array)
        {
        ...
        /// <param name="array">The array.</param>
        private static void FormatVector(StringBuilder builder, ArithArray array)
        {
        ...
        private static void FormatMatrix(StringBuilder builder, ArithArray array, string indent)
        {
            var storageFormat = GetStorageFormat(array.Storage, array);
            var format = storageFormat.Item1;
            var scale = storageFormat.Item2;
        ...
        /// <param name="builder">The builder.</param>
        /// <param name="array">The array.</param>
        private static void FormatTensor(StringBuilder builder, ArithArray array)
        {
            var storageFormat = GetStorageFormat(array.Storage, array);
            var format = storageFormat.Item1;
            var scale = storageFormat.Item2;
        ...
        /// <param name="array">The array.</param>
        /// <returns>System.String.</returns>
        public static string Format(ArithArray array)
        {
            var result = new StringBuilder();
            if (array.DimensionCount == 0)
            {
