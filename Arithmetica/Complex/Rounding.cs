...
namespace Arithmetica
{
    public partial class Complex
    {
        ...
        /// <summary>
        /// Clip (limit) the values in an complex. Given an interval, values outside the interval are clipped to the interval edges.For example, if an interval of[0, 1] is specified, values smaller than 0 become 0, and values larger than 1 become 1.
        /// </summary>
        /// <param name="src">The source complex.</param>
        ...
        /// <summary>
        /// Return the fractional and integral parts of an complex, element-wise. The fractional and integral parts are negative if the given number is negative.
        /// </summary>
        /// <param name="src">The source complex.</param>
        /// <returns></returns>
        ...
        /// Returns the standard deviation, a measure of the spread of a distribution, of the complex elements.The standard deviation is computed for the flattened complex by default, otherwise over the specified axis.
        /// </summary>
        /// <param name="src">The source complex.</param>
        /// <returns></returns>
