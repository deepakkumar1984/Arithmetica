...
namespace Arithmetica
{
    ...
    public class ArithArray : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArithArray"/> class.
        /// </summary>
        /// <param name="allocator">The allocator.</param>
        /// <param name="elementType">Type of the element.</param>
        /// <param name="sizes">The sizes.</param>
        public ArithArray(long[] sizes, DType elementType)
            : this(sizes, ArrayDimensionHelpers.GetContiguousStride(sizes), elementType)
        {
        }
        ...
        public ArithArray(long[] sizes, long[] strides, DType elementType)
        {
            ...
            this.storage = DeviceManager.Current.Allocate(elementType, ArrayDimensionHelpers.GetStorageSize(sizes, strides));
        }
        ...
        private ArithArray(long[] sizes, long[] strides, Storage storage, long storageOffset)
        {
            this.shape = sizes;
            this.strides = strides;
        ...
        {
            return ArrayFormatting.FormatTensorTypeAndSize(this);
        }
        ...
        {
            return ArrayFormatting.Format(this);
        }
        ...
        public long ElementCount()
        {
            ...
            elementCount = ArrayDimensionHelpers.ElementCount(shape);
            return elementCount.Value;
        }
        ...
        {
            return Core.ArrayResultBuilder.ArrayEqual(this.shape, other.shape);
        }
        ...
        public ArithArray View(params long[] sizes)
        {
            ...
            if (this.ElementCount() != ArrayDimensionHelpers.ElementCount(sizes))
            {
                throw new InvalidOperationException("Output array must have the same number of elements as the input");
            }

            return new ArithArray(sizes, ArrayDimensionHelpers.GetContiguousStride(sizes), this.storage, this.storageOffset);
        }
        ...
        public ArithArray Narrow(int dimension, long startIndex, long size)
        {
            ...
            return new ArithArray(newSizes, strides, storage, newOffset);
        }
        ...
        /// dimension2
        /// </exception>
        private ArithArray Transpose(int dimension1, int dimension2, bool NewContiguous = false)
        {
            ...
            if (NewContiguous)
                return ArrayOps.NewContiguous(new ArithArray(newSizes, newStrides, storage, storageOffset)).Reshape(newSizes);

            return new ArithArray(newSizes, newStrides, storage, storageOffset);
        }
        ...
        public ArithArray Expand(params long[] newSizes)
        {
            ...
            return new ArithArray(newSizes, newStrides, this.storage, this.storageOffset);
        }
        ...
        public ArithArray Unfold(int dimension, long size, long step)
        {
            ...
            return new ArithArray(newSize, newStrides, this.Storage, this.StorageOffset);
        }
        ...
        private ArithArray PadToDimCount(int newDimCount)
        {
            ...
            var newStrides = ArrayDimensionHelpers.GetContiguousStride(newSizes);
        ...
        public ArithArray RepeatTensor(params long[] repetitions)
        {
            ...
            var result = new ArithArray(resultSize, this.ElementType);
            ...
            ArrayOps.Copy(urTensor, expandedSrc);
        ...
        {
            ArraySerialization.Serialize(this, stream);
        }
        ...
        {
            return ArrayOps.Add(lhs, rhs);
        }

        public static ArithArray operator +(ArithArray lhs, float rhs) { return ArrayOps.Add(lhs, rhs); }

        public static ArithArray operator +(float lhs, ArithArray rhs) { return ArrayOps.Add(rhs, lhs); }

        public static ArithArray operator -(ArithArray lhs, ArithArray rhs)
        {
            return ArrayOps.Sub(lhs, rhs);
        }

        public static ArithArray operator -(ArithArray lhs, float rhs) { return ArrayOps.Sub(lhs, rhs); }

        public static ArithArray operator -(float lhs, ArithArray rhs) { return ArrayOps.Sub(lhs, rhs); }

        public static ArithArray operator *(ArithArray lhs, ArithArray rhs)
        {
            return ArrayOps.Mul(lhs, rhs);
        }

        public static ArithArray operator *(ArithArray lhs, float rhs) { return ArrayOps.Mul(lhs, rhs); }

        public static ArithArray operator *(float lhs, ArithArray rhs) { return ArrayOps.Mul(rhs, lhs); }

        public static ArithArray operator /(ArithArray lhs, ArithArray rhs)
        {
            return ArrayOps.Div(lhs, rhs);
        }

        public static ArithArray operator /(ArithArray lhs, float rhs) { return ArrayOps.Div(lhs, rhs); }

        public static ArithArray operator /(float lhs, ArithArray rhs) { return ArrayOps.Div(rhs, lhs); }

        public static ArithArray operator >(ArithArray lhs, ArithArray rhs) { return ArrayOps.GreaterThan(lhs, rhs); }

        public static ArithArray operator >(ArithArray lhs, float rhs) { return ArrayOps.GreaterThan(lhs, rhs); }

        public static ArithArray operator <(ArithArray lhs, ArithArray rhs)
        {
            return ArrayOps.GreaterThan(rhs, lhs);
        }
        ...
        public static ArithArray operator >=(ArithArray lhs, ArithArray rhs) { return ArrayOps.GreaterOrEqual(lhs, rhs); }

        public static ArithArray operator >=(ArithArray lhs, float rhs) { return ArrayOps.GreaterOrEqual(lhs, rhs); }

        public static ArithArray operator <=(ArithArray lhs, ArithArray rhs)
        {
            return ArrayOps.GreaterOrEqual(rhs, lhs);
        }
