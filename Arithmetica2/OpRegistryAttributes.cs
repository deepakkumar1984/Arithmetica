...
// ***********************************************************************
// <copyright file="OpRegistryAttributes.cs" company="Arithmetica">
...
namespace Arithmetica
{
    ...
    /// Implements the <see cref="Arithmetica.RegisterOp" />
    /// </summary>
    ...
    internal class RegisterOpStorageType : RegisterOp
    {
        ...
        public override void DoRegister(object instance, MethodInfo method, IEnumerable<OpConstraint> paramConstraints)
        {
            ...
            {
                if (methodParams[i].ParameterType == typeof(ArithArray))
                {
    ...
    /// Implements the <see cref="Arithmetica.ArgConstraintAttribute" />
    /// </summary>
